      ...
      <div class="container">
        <div class="row">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="inicioo" title="Sistema Ušnico de Gestión de Playas de Acarreo">SUGPA</a>
          </div>
...
<form role="form" method="post" action="/loginjava/bienvenido">
        ...
        <div class="container">
          ...
          <br>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-xs-6"><input class="form-control input-lg"  autocomplete="off" type="password" placeholder="Contraseña" id="Contraseña" required=""></div>
              </div>
              <br>
              <div class="row">
